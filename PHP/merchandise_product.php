...
// Get the merchandiseID from the URL
$merchandiseID = $_GET['merchandiseID'];

// Query the database for the merchandise details using the merchandiseID
...
if(mysqli_num_rows($result) > 0)
{
    ...
    // Output the merchandise details
